...
if '2016' in options['era']:
  ...
  options['HLTFILTERSTOMEASURE'].update(singleEG18_allFilters)
  options['HLTFILTERSTOMEASURE'].update(singleEG20_allFilters)
  options['HLTFILTERSTOMEASURE'].update(singleEG23_allFilters)
  options['HLTFILTERSTOMEASURE'].update(singleEG25_allFilters)
